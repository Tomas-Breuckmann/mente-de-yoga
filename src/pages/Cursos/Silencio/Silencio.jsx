      ...
      <S.SilencioMain>
        ...
        <S.SilencioContent>
          <T.H3 detach>Experiência do silêncio</T.H3>
			...
			<T.H3 detach> O que eu preciso para participar desta mentoria? </T.H3>
			<S.Grid4>
				<G.BasicCard>
					<str>Entusiasmo</str>
					<p>O desejo e a vontade de evoluir com amor, de se aprofundar no conhecimento dos sábios antigos e modernos para então silenciar e encontrar a si mesmo.</p>
				</G.BasicCard>
				<G.BasicCard>
					<str>Disponibilidade.</str>
					<p>Pelo menos 2 horas semanais, para se dedicar a aula ao vivo e a sessão de acompanhamento individual.</p>
				</G.BasicCard>
				<G.BasicCard>
					<str>Compromisso</str>
					<p>com sua evolução pessoal para realizar as atividades que serão propostas a cada aula ao vivo.</p>
				</G.BasicCard>
				<G.BasicCard>
					<str>Coragem</str>
					<p>Para silenciar, encontrar a si mesmo, e encarar de frente o que quer que você encontre.</p>
				</G.BasicCard>
			</S.Grid4>
			<S.Botao>
				<div>Apenas 5 vagas!</div>
